...
- PR-1 branch `feature/fase-3-internas-pr1-foundation`; PR targets `develop`. Each later slice uses
  its own `feature/fase-3-internas-prN-*` branch and also targets `develop`.
